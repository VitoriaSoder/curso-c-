...
var y = Convert.ToInt32(Console.ReadLine("Digite um número"));
var x = Convert.ToInt32(Console.ReadLine("Digite um número"));

var parOrImparX = x % 2 == 0 ? "Par" : "Impar";
var parOrImparY = y % 2 == 0 ? "Par" : "Impar";

Console.WriteLine("X é: " + parOrImparX);
Console.WriteLine("Y é: " + parOrImparY);
...
int x = Convert.ToInt32(Console.ReadLine("Digite um número"));
...
Console.WriteLine("3 x^2 + x + 10: " + (3 * x * x + x + 10));
Console.WriteLine("pi * x^2: " + (3.1415 * x * x));
...
var celsius = Convert.ToInt32(Console.ReadLine("Digite a temperatura em graus Celsius"));

Console.WriteLine("Temperatura em Kelvin: " + (celsius + 273));
Console.WriteLine("Temperatura em Farhenheit: " + ((celsius * 9) / 5 + 32));
...
//res: O resultado para essa operação é a sequencia (5, 2, 2, 2), o ++ na frente é representado como antes de imprimir o valor ele soma 1 e o -- na frente é representado como antes de imprimir o valor ele subtraiu 1
